...
const Form = () => {
  ...
  return (
    <div className="h-full w-full flex items-center flex-col justify-center px-4 bg-primary py-[20px] bg-[url('/src/assets/images/home.png')] ">
      {/* <img src="/src/assets/images/form.png" alt="not found" className="w-[12%] h-[12%] rounded-lg" /> */}
      <form
        action="#"
        className="mb-6 md:w-1/2 w-full  block items-center justify-center gap-y-3 flex-col"
      >
        <div className="mb-6">
          <input
            type="text"
      ...
      <p className="mb-2 cursor-pointer text-sm text-gray-500 dark:text-gray-400">
        <a href="mailto:maanilv8@gmail.com" className="hover:underline">
          ahmadmudasircs@gmail.com
        </a>
      </p>
      <p className="text-sm cursor-pointer text-gray-500 dark:text-gray-400">
        <a href="tel:+919312257176" className="hover:underline">
          +92-3099726351
        </a>
      </p>
      <ToastContainer />
